...
def my_corner(size=2):
    ...
    fig = pt.figure(tight_layout=True, figsize=(5, 5))
...
def my_corner_outliers(size=2):
    ...
    fig = pt.figure(tight_layout=True, figsize=(5.3, 5))
...
def my_box(rows=2, cols=2, figsize=(5.3, 5), sharex=False, sharey=False):
