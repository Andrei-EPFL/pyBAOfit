...
def main():
  ...
  # models = [f"{main_baoflit_tmp}cg/BAOfit_CATALPTCICz0.466G960S1057271749.VOID_", f"{main_box1_fit}vv2pcf_CG/stitched_16R_G2048_50_G512_2000_CG/BAOfit_CATALPTCICz0.466G960S1057271749.VOID.dat.2pcf_"]
  
  # ofile = f"{main_baoflit_tmp}BAOfit_avg_sc_CG_nuisance.png"
  # models = [f"{main_baoflit_tmp}cg/BAOfit_avg_sc_", f"{main_box1_fit}range_test/vv2pcf/scaled_covariance/stitched_16R_G2048_50_G512_2000_CG_60_150/BAOfit_avg_16R.2pcf_"]
