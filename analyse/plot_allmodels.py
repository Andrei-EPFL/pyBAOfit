...
def plot_corner(samples, ofile):
  ...
  g.triangle_plot(samples, filled='True', legend_labels=['Parabola', 'Void', 'VoidGL2'], \
      line_args=[{'lw':0.1, 'color':'grey'}, {'lw':0.5, 'color':'red'},{'lw':0.5, 'color':'blue'}], contour_colors=['grey','red', 'blue'])
...
def main():
  ...
  ofile = './output/' + fileroot +'getdist_60_150_rescaled.pdf'
  
  
  #sample_gal = my_sample(inpath + "/galaxy_60_150/BAOfit_avg_16R.2pcf_", 3)
  #sample_par = my_sample(inpath + "/parab_60_150/BAOfit_avg_16R.2pcf_", 4)
  #sample_voi = my_sample(inpath + "/voidtemplate_60_150/BAOfit_avg_16R.2pcf_", 3)
